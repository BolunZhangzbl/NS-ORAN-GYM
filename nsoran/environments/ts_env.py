...
class TrafficSteeringEnv(NsOranEnv):
    def __init__(self, ns3_path:str, scenario_configuration:dict, output_folder:str, optimized:bool, verbose=False, time_factor=0.001, Cf=1.0, lambdaf=0.1):
        ...
        """
        super().__init__(ns3_path=ns3_path, scenario='scenario-zero', scenario_configuration=scenario_configuration,
    ...
    def _compute_reward(self) -> float:
        ...
        print(f"self.previous_kpms: {self.previous_kpms}")
        print(f"current_kpms: {current_kpms}")
